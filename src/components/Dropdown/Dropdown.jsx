...
Dropdown.propTypes = {
  buttonText: PropTypes.node.isRequired,  // children must be a valid React node and is required
  content: PropTypes.node.isRequired,   // onClick must be a function and is required
};
